...
import com.example.bookaih.adapter.OrderWeddingAdatpter;
...
public class OrderWedding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_wedding);
...
//        recycler.setAdapter(adatpter);
        ...
        database.getWeddingOrders(new FireDatabase.OrderWeddingCallback() {
            @Override
            public void onCallback(ArrayList<OrderWeddingModel> list) {
                if (list.size() == 0) {
                    ...
                    adatpter = new OrderWeddingAdatpter(getBaseContext(), list);
                    recycler.setAdapter(adatpter);
                }
            }
        });
