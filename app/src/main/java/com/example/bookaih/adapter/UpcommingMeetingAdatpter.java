...
import com.example.bookaih.admin.OrderMeetingDetail;
...
public class UpcommingMeetingAdatpter extends RecyclerView.Adapter<UpcommingMeetingAdatpter.ViewHolder> {
    ...
    public UpcommingMeetingAdatpter(Context context, ArrayList<MeetModel> data) {
            ...
            public void onCallback(UserModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(context, OrderMeetingDetail.class);
